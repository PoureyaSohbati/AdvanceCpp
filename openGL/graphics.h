...
class object {
   ...
   public:
      ...
      object (shared_ptr<shape> pshape, vertex center, rgbcolor color) :
              pshape(pshape), center(center), color(color){} 
...
class window {
   ...
   public:
      ...
      static void setborder (rgbcolor color_, GLfloat size_) {
                  borderColor = color_; borderSize = size_;
                  border = true; }
      static rgbcolor getborderColor (){return borderColor; }
      static bool haveborder (){ return border; }
      static void main();
};
