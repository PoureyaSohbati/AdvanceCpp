...
class inode_state {
   ...
   public:
      inode_state();
      //void changeRoot(inode_ptr root_dir);
      void changeCWD(inode_ptr& CWD);
      void changePrompt(const string& prompt);
      inode_ptr& getCWD();
      inode_ptr& getRoot();
      const string& getPrompt();
      const vector<string>&  getPath();
      //void addToPath(const string& dirname);
      //void rmFromPath();
      //void setPathToRoot();
      void setPath(const vector<string>& newPath);
};
...
class directory: public file_base {
   ...
   public:
      ...
      map<string, inode_ptr>& getmap();
      void addToMap(const string& filename, inode_ptr ptr);
};
